        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <input type="email" id="email" name="email" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-sm">
              @error('email')
              <span class="text-red-500">{{ $message }}</span>
              @enderror
            </div>
            ...
            <div class="sm:col-span-2">
              ...
              <input type="text" id="address" name="address" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-sm">
              @error('address')
              <span class="text-red-500">{{ $message }}</span>
              @enderror
            </div>
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
              ...
              <div>
                ...
                <input type="number" id="amount" name="amount" min="1" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all text-sm">
                @error('amount')
                <span class="text-red-500">{{ $message }}</span>
                @enderror
              </div>
